...
/**
 * This class represent the <b>Appliance Statistics</b> Cluster as defined by
 * the document:<br>
...
public class ApplianceStatisticsCluster extends ZCLClusterBase implements
		ApplianceStatistics {

	private static AttributeImpl description;
	private final Attribute[] attributes;

	public ApplianceStatisticsCluster(ZigBeeDevice zbDevice) {
		super(zbDevice);
	...
	@Override
	public short getId() {
		return ApplianceStatistics.ID;
	}

	@Override
	public String getName() {
		return ApplianceStatistics.NAME;
	}
