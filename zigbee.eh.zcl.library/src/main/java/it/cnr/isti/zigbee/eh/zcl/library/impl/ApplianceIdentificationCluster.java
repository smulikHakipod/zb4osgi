...
public class ApplianceIdentificationCluster extends ZCLClusterBase implements
		ApplianceIdentification {

	private static AttributeImpl description;
	private final Attribute[] attributes;

	public ApplianceIdentificationCluster(ZigBeeDevice zbDevice) {
		super(zbDevice);
	...
	@Override
	public short getId() {
		return ApplianceIdentification.ID;
	}

	@Override
	public String getName() {
		return ApplianceIdentification.NAME;
	}
	...
	/* (non-Javadoc)
	 * @see it.cnr.isti.zigbee.eh.zcl.library.api.ApplianceIdentification#getStartTime()
	 */
	...
	/* (non-Javadoc)
	 * @see it.cnr.isti.zigbee.eh.zcl.library.api.ApplianceIdentification#getFinishTime()
	 */
	...
	/* (non-Javadoc)
	 * @see it.cnr.isti.zigbee.eh.zcl.library.api.ApplianceIdentification#getRemainingTime()
	 */
