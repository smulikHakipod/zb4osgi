...
public class MeterIdentificationCluster extends ZCLClusterBase implements
		MeterIdentification {

	private static AttributeImpl description;
	private final Attribute[] attributes;

	public MeterIdentificationCluster(ZigBeeDevice zbDevice) {
		super(zbDevice);
	...
	@Override
	public short getId() {
		return MeterIdentification.ID;
	}

	@Override
	public String getName() {
		return MeterIdentification.NAME;
	}
