 ...
 * @since 0.3.0
 */
public interface EHListenerFactoryService {
	
	public final static String BRIDGED_EVENTS = "org.persona.zigbee.eh.event.bridgedevents";
	 ...
	 */
	public boolean addListener(Cluster cluster, EHGenericListener listener);
	 ...
	 * as listener of the events generated by the {@link Cluster}
	 */
	public boolean removeListener(Cluster cluster, EHGenericListener listener);
