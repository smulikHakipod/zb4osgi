 ...
 *
 */
public class UnknownHADeviceFactory extends HADeviceFactoryBase   {

    private String[] implementedInterfaces = {
                    HADevice.class.getName()
    };

    public  UnknownHADeviceFactory(BundleContext ctx) throws ZigBeeHAException {
        super(ctx, UnknownHADevice.class);
    }
    ...
    public String getDeviceId() {
        return UnknownHADevice.DEVICE_ID;
    }
    ...
    public HADeviceBase getInstance(ZigBeeDevice zbDevice) throws ZigBeeHAException {
        return new UnknownHADevice(ctx, zbDevice);
    }
