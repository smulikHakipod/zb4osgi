...
import it.cnr.isti.zigbee.hc.cluster.glue.protocol_interfaces.GenericTunnel;
 ...
 * @version $LastChangedRevision$ ($LastChangedDate: 2014-01-17 18:00:09
 *          +0100 (ven, 17 gen 2014) $)
 * @since 0.1.0
 * 
 */
public interface HCDevice {
	...
	public static final int[] MANDATORY = {HCProfile.BASIC, HCProfile.IDENTIFY,
			HCProfile.GENERIC_TUNNEL, HCProfile.PROTOCOL_TUNNEL_11073};

	public static final int[] OPTIONAL = {HCProfile.POWER_CONFIGURATION,
			HCProfile.ALARMS, HCProfile.TIME, HCProfile.RSSI_LOCATION,
			HCProfile.ALPHA_SECURE_KEY_ESTABLISHMENT,
			HCProfile.ALPHA_SECURE_ACCESS_CONTROL, HCProfile.PARTITION,
	...
	/**
	 * 
	 * @return an <code>int</code> representing the <b>DeviceId</b> as defined
	 *         by the<br>
	...
	/**
	 * Access method for the <b>Mandatory</b> cluster:
	 * {@link DeviceTemperatureConfiguration}
	 * 
	 ...
	 * 
	 * <b>NOTE</b>: The {@link DeviceDescription} <b>should</b> be shared among
	 * all {@link HADeviceBase}<br>
	 ...
	 * 
	 * @param id
	 *            the <code>int</code> representing the <b>ClusterId</b>
	 * @return the {@link Cluster} identified by the given id if this device
	 *         implements<br>
	...
	/**
	 * 
	 * @return the {@link Cluster} array effectively implemented by the remote
	 *         ZigBee Device<br>
	 *         otherwise <code>null</code>
	 */
	...
	/**
	 * 
	 * @return return {@link ZigBeeDevice} service that has been refined has
	 *         {@link HCDevice}
	 * @since 0.2.0
	 * @deprecated The method should be avoided because it cause Service
	 *             Reference Leak
	 */
