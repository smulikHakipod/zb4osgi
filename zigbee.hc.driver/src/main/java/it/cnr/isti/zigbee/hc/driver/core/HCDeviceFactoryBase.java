 ...
 *
 */
public abstract class HCDeviceFactoryBase implements HCDeviceFactory {

    private static final Logger logger = LoggerFactory.getLogger(HCDeviceFactoryBase.class);
     ...
     */
    public HCDeviceFactoryBase(BundleContext ctx, Class<?> refinement) {
        this.ctx = ctx;
        this.refinement = refinement;
        dictionary = new Properties();
        dictionary.put(ZigBeeDevice.PROFILE_ID, Integer.toString(HCProfile.ID));
    }
    ...
    public abstract HCDeviceBase getInstance(ZigBeeDevice zbDevice) throws  ZigBeeHCException;
    ...
    public HCDeviceFactoryBase register() {
        ...
        registration = ctx.registerService(HCDeviceFactory.class.getName(), this, dictionary);
        return this;
    }

    public HCDeviceFactoryBase unregister() {
