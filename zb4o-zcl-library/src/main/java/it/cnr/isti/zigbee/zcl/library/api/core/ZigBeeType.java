...
public enum ZigBeeType  {
    ...
    UnsignedInteger40bit(0x24, 5, true, Long.class),
    UnsignedInteger48bit(0x25, 6, true, Long.class),
    UnsignedInteger56bit(0x26, 7, true, Long.class),
    ...
    Enumeration8bit(0x30, 1, false, Integer.class),
    ...
    SignedInteger40bit(0x2c, 5, true, Long.class),
    SignedInteger48bit(0x2d, 6, true, Long.class),
    SignedInteger56bit(0x2e, 7, true, Long.class),
    SignedInteger64bit(0x2f, 8, true, Long.class),
    SemiPrecision(0x38, 2, true, Short.class),
    SinglePrecision(0x39, 4, true, Float.class),
    DoublePrecision(0x3a, 8, true, Double.class),
    //sistemare
    UnsignedInteger64bit(0x27, 8, true, Long.class),
