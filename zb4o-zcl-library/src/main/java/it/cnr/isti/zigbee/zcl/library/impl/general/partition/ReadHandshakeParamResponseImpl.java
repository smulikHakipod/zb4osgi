...
public class ReadHandshakeParamResponseImpl extends ResponseImpl implements ReadHandshakeParamResponse {

	public ReadHandshakeParamResponseImpl(Response response) {
		super(response);
