...
/**
 * This class represent the <b>Appliance Events And Alert</b> Cluster as defined
 * by the document:<br>
...
public class ApplianceEventsAndAlertCluster extends ZCLClusterBase implements
		ApplianceEventsAndAlert {

	private static AttributeImpl description;
	private final Attribute[] attributes;

	public ApplianceEventsAndAlertCluster(ZigBeeDevice zbDevice) {
		super(zbDevice);
	...
	@Override
	public short getId() {
		return ApplianceEventsAndAlert.ID;
	}

	@Override
	public String getName() {
		return ApplianceEventsAndAlert.NAME;
	}
