 ...
 * @since 0.1.0
 * @deprecated From version 0.7.0 please use the
 *             {@link ByteArrayOutputStreamSerializer} instead
 *
 */
public class DefaultSerializer implements ZBSerializer {
     ...
     *
     * @param payload
     *            the byte array that will used for storing the serialiazed data
     * @param index
     *            the first empty byte where data will be written
     * @deprecated From version 0.7.0 please use the
     *             {@link ByteArrayOutputStreamSerializer} instead
     */
    ...
    public void appendString(String str) {
        ...
        if (raw.length > 255) {
            throw new IllegalArgumentException("Given string '" + str
                    + "' is too long - maximum String size is 255.");
        }
    ...
    public void appendFloat(Float data) {
        final String msg = "appendFloat: we are not going to implement it because this class is depreacated please use the "
                + ByteArrayOutputStreamSerializer.class.getName();
        throw new UnsupportedOperationException(msg);
    }

    public void append_long(long data, int size) {
        final String msg = "append_long: we are not going to implement it because this class is depreacated please use the "
                + ByteArrayOutputStreamSerializer.class.getName();
        throw new UnsupportedOperationException(msg);
    }
}
