...
public interface ReportingConfiguration extends ManagedService {
     ...
     */
    public static final String CONFIGURE_REPORTING_MIN_KEY = "it.cnr.isti.zigbee.eh.reporting.min";
    /**
     ...
     */
    public static final String CONFIGURE_REPORTING_MAX_KEY = "it.cnr.isti.zigbee.eh.reporting.max";
    /**
     ...
     */
    public static final String CONFIGURE_REPORTING_CHANGE_KEY = "it.cnr.isti.zigbee.eh.reporting.change";
    /**
     ...
     */
    public static final String CONFIGURE_REPORTING_OVERWRITE_KEY = "it.cnr.isti.zigbee.eh.reporting.overwrite";
    /**
