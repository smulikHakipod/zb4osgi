...
package it.cnr.isti.zigbee.eh.device.impl;
 ...
 *
 */
public class GenericEHDevice extends EHDeviceBase {
	
	private int[] mandatory;
	private int[] optional;
	private int[] standard;
	private int[] custom;
	public GenericEHDevice(BundleContext ctx,ZigBeeDevice zbDevice) throws ZigBeeHAException{
		super(ctx,zbDevice);
...
//			if (EHProfile.clusters.containsKey(clusterIDs[i])){
